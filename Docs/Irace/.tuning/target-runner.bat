...
SET "exe=D:\Estudos\Mestrado\VRP\prj_vrppl\a.exe"
...
%exe% -i %instance% --seed %seed% %candidate_parameters% 1>%stdout% 2>%stderr%
...
:: TODO Deu erro aqui no tokens com o valor padrão (tokens=3)
echo %COST%
